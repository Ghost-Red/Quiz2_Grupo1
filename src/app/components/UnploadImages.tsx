...
py-2 px-4 rounded w-full sm:w-auto"
      >
        Select Image
      </button>
      {selectedFile && (
        <div className="flex justify-center">
          <button
            ...
            className="bg-amber-600 hover:bg-blue-700 text-white fontbold py-2 px-4 rounded w-full sm:w-auto mt-4"
          >
            Upload
          </button>
        </div>
      ...
      {!imageUrl && (
        <div className="flex justify-center my-5">
          <iframe
            ...
            height="400"
            src="https://www.youtube.com/embed/l5OaRxsobqI?autoplay=1&loop=1&playli
st=l5OaRxsobqI"
            frameBorder="0"
